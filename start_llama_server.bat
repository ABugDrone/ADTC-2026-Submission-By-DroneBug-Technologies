...
llama-server.exe -m "%ROOT%model\tiny-aya-earth-q4_k_m.gguf" --jinja -c 2048 -t 2 -b 512 --host 127.0.0.1 --port 8033 --embedding --pooling mean >> "%ROOT%llama_stdout.log" 2>&1
